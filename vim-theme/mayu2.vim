...
hi LineNr ctermfg=240 ctermbg=NONE cterm=NONE guifg=#3c464f guibg=#0C151E gui=NONE
hi VertSplit ctermfg=234 ctermbg=0 cterm=bold guifg=#3c464f guibg=#0C151E gui=bold
hi MatchParen ctermfg=207 ctermbg=NONE cterm=underline guifg=#FF4143 guibg=NONE gui=underline
...
hi IncSearch ctermfg=0 ctermbg=51 cterm=NONE guifg=#0C151E guibg=#FFCC4B gui=NONE
hi Search ctermfg=0 ctermbg=226 cterm=NONE guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
...
hi Boolean ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
hi Character ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
hi Comment ctermfg=240 ctermbg=NONE cterm=NONE guifg=#3c464f guibg=NONE gui=NONE
hi Conditional ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
hi Constant ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi Define ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
...
hi ErrorMsg ctermfg=231 ctermbg=207 cterm=NONE guifg=#f8f8f0 guibg=#FF4143 gui=NONE
hi WarningMsg ctermfg=231 ctermbg=207 cterm=NONE guifg=#f8f8f0 guibg=#FF4143 gui=NONE
hi Float ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
hi Function ctermfg=216 ctermbg=NONE cterm=NONE guifg=#1094C3 guibg=NONE gui=NONE
hi Identifier ctermfg=225 ctermbg=NONE cterm=NONE guifg=#3DE163 guibg=NONE gui=italic
hi Keyword ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
hi Label ctermfg=229 ctermbg=NONE cterm=NONE guifg=#FFCC4B guibg=NONE gui=NONE
hi NonText ctermfg=231 ctermbg=NONE cterm=NONE guifg=#525563 guibg=#0C151E gui=NONE
hi Number ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
hi Operator ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
hi PreProc ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
...
hi Statement ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
hi StorageClass ctermfg=207 ctermbg=NONE cterm=NONE guifg=#3DE163 guibg=NONE gui=italic
hi String ctermfg=229 ctermbg=NONE cterm=NONE guifg=#FFCC4B guibg=NONE gui=NONE
hi Tag ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
...
hi rubyClass ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
hi rubyFunction ctermfg=216 ctermbg=NONE cterm=NONE guifg=#1094C3 guibg=NONE gui=NONE
hi rubyInterpolationDelimiter ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi rubySymbol ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
hi rubyConstant ctermfg=225 ctermbg=NONE cterm=NONE guifg=#3DE163 guibg=NONE gui=italic
hi rubyStringDelimiter ctermfg=229 ctermbg=NONE cterm=NONE guifg=#FFCC4B guibg=NONE gui=NONE
hi rubyBlockParameter ctermfg=216 ctermbg=NONE cterm=NONE guifg=#FFA244 guibg=NONE gui=italic
hi rubyInstanceVariable ctermfg=207 ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi rubyInclude ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
hi rubyGlobalVariable ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi rubyRegexp ctermfg=229 ctermbg=NONE cterm=NONE guifg=#FFCC4B guibg=NONE gui=NONE
hi rubyRegexpDelimiter ctermfg=229 ctermbg=NONE cterm=NONE guifg=#FFCC4B guibg=NONE gui=NONE
hi rubyEscape ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
hi rubyControl ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
hi rubyClassVariable ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi rubyOperator ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
hi rubyException ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
...
hi htmlSpecialChar ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
...
hi yamlKey ctermfg=207 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
hi yamlAnchor ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi yamlAlias ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi yamlDocumentHeader ctermfg=229 ctermbg=NONE cterm=NONE guifg=#FFCC4B guibg=NONE gui=NONE
hi cssURL ctermfg=216 ctermbg=NONE cterm=NONE guifg=#FFA244 guibg=NONE gui=italic
hi cssFunctionName ctermfg=225 ctermbg=NONE cterm=NONE guifg=#3DE163 guibg=NONE gui=NONE
hi cssColor ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
hi cssPseudoClassId ctermfg=216 ctermbg=NONE cterm=NONE guifg=#1094C3 guibg=NONE gui=NONE
hi cssClassName ctermfg=216 ctermbg=NONE cterm=NONE guifg=#1094C3 guibg=NONE gui=NONE
hi cssValueLength ctermfg=14 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
...
hi elixirInterpolationDelimiter ctermfg=216 ctermbg=NONE cterm=NONE guifg=#1094C3 guibg=NONE gui=NONE
hi elixirStringDelimiter ctermfg=229 ctermbg=NONE cterm=NONE guifg=#FFCC4B guibg=NONE gui=NONE
"}}}
"
" Vim Script {{{
